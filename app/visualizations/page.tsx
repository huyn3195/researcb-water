      ...
      <div className="flex flex-col items-start justify-start flex-grow p-8">
        ...
        <div className="mt-8 text-lg text-gray-700">
          ...
          <p className="mb-4">
            ...
            quantity. To get the classifications in the correct order, a manual
            order had to be written that would make the more sense. Then, a
            specific color palette was imported, helping the viewer visualize
          ...
          <p className="mb-4">
            ...
            to Medium”. As the physical risk groups increase in severity, we see
            the counts of institutions in each classification decreasing as the
            physical risk quantity gets more extreme.
          </p>
          ...
          <p className="mb-4">
            ...
            classification of physical risk quantity. The ordering and coloring
            of the physical risk quantities is consistent with the previous bar
            chart.
          </p>
          <p className="mb-4">
            The chart indicates that on average, the institutions with the lower
            risk classifications may also have a lower percentage reduction in
            potable water use per weighted campus user from the baseline amount
            (only an assumption as statistical significance between box plots
            was not calculated). This trend follows the logic that an
            institution performing well in their physical risk classification
            would find difficulty in further reductions (plateauing in success).
          </p>
          <p className="mb-4">
            As the physical risk groups increase in severity, the classification
            groups with higher risk have (on average) a higher reduction in
            potable water use per weighted campus user from the baseline amount.
            In context, these institutions have more room for improvement in
            their reduction. These higher risk groups especially need to target
            a higher reduction.
          </p>
          <p className="mb-4">
            Given the schools of focus are within two groups (Catholic Benchmark
            and MN Peer institutions), The dataset was filtered to just include
            these two groups for further visualizations.
          </p>
          ...
          <p className="mb-4">
            ...
            variables. Most institutions are clustered in the bottom left corner
            of the graph which indicates lower values for both variables, but
            there are a couple higher values for both variables across the plot
          ...
          <p>
            ...
            The distribution is somewhat normal but far from perfect, given the
            difficulty in having a normal distribution with only 14 cases. The
            values are spread across from 0 to 6 and there are no outliers.
          </p>
